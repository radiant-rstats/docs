...
Radiant is a platform-independent browser-based interface for business analytics in [R](https://www.r-project.org/), based on the [Shiny](https://shiny.rstudio.com/) package. Developed by <a href="https://rady.ucsd.edu/faculty-research/faculty/vincent-nijs.html" target="_blank">Vincent Nijs</a>. Please use the issue tracker on GitHub to suggest enhancements or report problems: <a href="https://github.com/radiant-rstats/radiant/issues" target="_blank">https://github.com/radiant-rstats/radiant/issues</a>. For other questions and comments please use radiant@rady.ucsd.edu.
...
* If you have a mac with an Intel Chip (models prior to late 2020), download and install R 4.2.3, which is the final release supported for Intel Macs, from <a href="https://cloud.r-project.org/bin/macosx/base/R-4.2.3.pkg" target="_blank">https://cloud.r-project.org/bin/macosx/base/R-4.2.3.pkg</a>
