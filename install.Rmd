...
#### 4. Install Tex (required to generate reports in PDF format)

For Mac download and install: http://tug.org/cgi-bin/mactex-download/MacTeX.pkg
For Windows download and install: http://miktex.org/download
