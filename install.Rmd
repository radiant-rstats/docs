...
> **Note:** R 3.6 or higher is required to use the latest version of Radiant.
...
```r
install.packages(c("radiant.update", "fs"), repos = "https://radiant-rstats.github.io/minicran/")
