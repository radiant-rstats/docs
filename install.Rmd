...
For Windows, download and run the all-in-one installer for <a href="https://www.dropbox.com/s/byjyacofelu0ljd/Rady-Radiant-Installer-Latest.exe?dl=1" target="_blank">R, Rstudio, and Radiant</a>. For a video tutorial see the `Install Radiant on Windows` video below:
