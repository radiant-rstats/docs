...
> **Important:** If you use Windows and are asked where to install Radiant (i.e., "Would you like to use a personal library instead?") you did **not** install R in directory C:\\R\\R-`r rv` as stated above. You will need to uninstall and reinstall R in the suggested directory before proceeding.
...
you will need to reinstall R into C:\\R\\R-`r rv` as mentioned above. You should also remove the directory Documents\\R from your computer
