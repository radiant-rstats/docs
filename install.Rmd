...
For Windows, download and run the all-in-one installer for <a href="https://www.dropbox.com/s/oy1x4cdxegs4bau/Rady-Radiant-Installer-Latest.exe?dl=1">R, Rstudio, and Radiant</a>. If you see a warning message like the image shown below when you run the installer click on "More info" and then on "Run anyway".
...
> Credits: Thanks go to Brandon Salas (Rady School of Management @ UCSD) for creating the Windows installer and Greg Aujero (Rady School of Management @ UCSD) for update the installer
