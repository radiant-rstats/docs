...
wget -O rstudio-preview-amd64.deb https://s3.amazonaws.com/rstudio-ide-build/desktop/trusty/amd64/rstudio-1.2.1004-amd64.deb
sudo gdebi rstudio-preview-amd64.deb
rm rstudio-preview-amd64.deb
```

Then open R(studio) and run the following command:
