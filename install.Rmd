...
For Windows, download and run the all-in-one installer for [R, Rstudio, and Radiant](https://rady.ucsd.edu/faculty/directory/vnijs/Rady-Radiant-Installer-Latest.exe){target="_blank"}. For a video tutorial see the `Install Radiant on Windows` video below:
