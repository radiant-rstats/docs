...
Built using <a href="https://shiny.posit.co/" target="_blank">Shiny</a> by <a href="https://posit.co/" target="_blank">Rstudio</a>. The full source code is available on <a href="https://github.com/radiant-rstats" target="_blank">GitHub</a>

## Package dependencies

```{r setup, include = FALSE}
source("https://raw.githubusercontent.com/radiant-rstats/minicran/gh-pages/pkgs.R")
```
