...
# rsync -av ~/gh/docs/model/figures_model/  ~/gh/radiant.model/inst/app/tools/help/figures/
...
rsync -nav ~/gh/docs/basics/app/  ~/gh/radiant.basics/inst/app/tools/help/
rsync -nav ~/gh/docs/basics/figures_basics/*  ~/gh/radiant.basics/inst/app/tools/help/figures/

rsync -nav ~/gh/docs/model/app/  ~/gh/radiant.model/inst/app/tools/help/
rsync -nav ~/gh/docs/model/figures_model/  ~/gh/radiant.model/inst/app/tools/help/figures/

rsync -nav ~/gh/docs/multivariate/app/  ~/gh/radiant.multivariate/inst/app/tools/help/
