...
> Note that when a categorical variable (`factor`) is selected as the `Y-var` in a Bar chart it is converted to a 0-1 (binary) variable where the first level is coded as 1 and all other levels as 0.
